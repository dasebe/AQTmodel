...
#ifndef __GAUSSIANCHANNEL_H
#define __GAUSSIANCHANNEL_H
 ...
 * @ingroup SimCore
 */
class SIM_API GaussianChannel : public cChannel //implies noncopyable
{
  protected:
  ...
  public:
     ...
     */
    explicit GaussianChannel(const char *name=NULL);

    /**
     * Destructor.
     */
    virtual ~GaussianChannel();

    /**
     * Utility function for dynamic channel creation. Equivalent to
     * <tt>cChannelType::getDatarateChannelType()->create(name)</tt>.
     */
    static GaussianChannel *create(const char *name);
    //@}
