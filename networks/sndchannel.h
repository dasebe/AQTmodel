...
#ifndef __CSNDCHANNEL_H
#define __CSNDCHANNEL_H
 ...
 * @ingroup SimCore
 */
class SIM_API sndChannel : public cChannel //implies noncopyable
{
  protected:
  ...
  public:
     ...
     */
    explicit sndChannel(const char *name=NULL) : cChannel(name) {}
     ...
     */
    static sndChannel *create(const char *name);
    //@}
