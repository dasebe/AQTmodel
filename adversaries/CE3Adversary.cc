 ...
 */
class CE3Adversary : public cSimpleModule
{
  private:
    // configuration
    cPar *timeSlots;
...
Define_Module(CE3Adversary);


CE3Adversary::CE3Adversary()
{
    selfNote = NULL;
}
...
void CE3Adversary::handleMessage(cMessage *msg)
{
