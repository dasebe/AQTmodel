 ...
 */
class CE7AdversaryNonForwardConstraint : public cSimpleModule
{
  private:
    // configuration
    cPar *timeSlots;
  ...
  public:
    CE7AdversaryNonForwardConstraint();
    virtual ~CE7AdversaryNonForwardConstraint();
...
Define_Module(CE7AdversaryNonForwardConstraint);


CE7AdversaryNonForwardConstraint::CE7AdversaryNonForwardConstraint()
{
    selfNote = NULL;
}
...
void CE7AdversaryNonForwardConstraint::initialize()
{
...
//round 0
    ...
    selfNote->setSchedulingPriority(1); //higher means lower priority, normal packets get 4 (default value is 0)
...
//round 1
    ...
    (*tmp).message->setPath(3,91);
    (*tmp).message->setPath(4,12);
    (*tmp).message->setPath(5,11);
    (*tmp).message->setPath(6,103);
    (*tmp).message->setPath(7,101);//first hop
    (*tmp).message->setKind(101);
    //schedule event message for this injection class
    selfNote = new cMessage("S: A1");
    selfNote->setKind(tmpi++); //this means that the first entry of the injection struct shall be started by this message
    selfNote->setSchedulingPriority(2); //higher means lower priority, normal packets get 4 (default value is 0)
    //when to start this phase
...
//round 2
    ...
    (*tmp).message->setPath(1,23);
    (*tmp).message->setPath(2,93);
    (*tmp).message->setPath(3,91);
    (*tmp).message->setPath(4,22);
    (*tmp).message->setPath(5,21);
    (*tmp).message->setKind(101);
    //schedule event message for this injection class
...
//round 3
    ...
    (*tmp).atNode = "c0";
    (*tmp).message->setPathArraySize(3);
    (*tmp).message->setPath(0,95);
    (*tmp).message->setPath(1,94);
    (*tmp).message->setPath(2,32);
    (*tmp).message->setKind(101);
    //schedule event message for this injection class
    ...
    (*tmp).message->setPath(0,14); //last hop
    (*tmp).message->setPath(1,13);
    (*tmp).message->setPath(2,12);
    (*tmp).message->setPath(3,11);
    (*tmp).message->setPath(4,103);
    (*tmp).message->setPath(5,101);//first hop
    (*tmp).message->setKind(101);
    //schedule event message for this injection class
    ...
    (*tmp).message->setPath(1,33);
    (*tmp).message->setPath(2,93);
    (*tmp).message->setPath(3,91);
    (*tmp).message->setPath(4,32);
    (*tmp).message->setPath(5,31);
    (*tmp).message->setKind(101);
    //schedule event message for this injection class
...
void CE7AdversaryNonForwardConstraint::handleMessage(cMessage *msg)
{
