...
//* deprecated configuration style! (still works)
 ...
 * Adversary
 */
class BBhalf : public cSimpleModule
{
  private:
    // configuration
    cPar *timeSlots;
...
void BBhalf::initialize()
{
    ...
    injections[0].atNode = "n1";
    injections[0].message->setPathArraySize(1);
    injections[0].message->setPath(0,12);//first hop
    ...
    injections[1].atNode = "n1";
    injections[1].message->setPathArraySize(4);
    injections[1].message->setPath(0,22); //last hop
    injections[1].message->setPath(1,21);
    injections[1].message->setPath(2,13);
    injections[1].message->setPath(3,12);//first hop
    ...
    injections[2].atNode = "n2";
    injections[2].message->setPathArraySize(1);
    injections[2].message->setPath(0,13);
    ...
    injections[3].atNode = "n1";
    injections[3].message->setPathArraySize(4);
    injections[3].message->setPath(0,22); //last hop
    injections[3].message->setPath(1,21);
    injections[3].message->setPath(2,14);
    injections[3].message->setPath(3,12);//first hop
    ...
    injections[4].atNode = "m1";
    injections[4].message->setPathArraySize(1);
    injections[4].message->setPath(0,21);
...
void BBhalf::handleMessage(cMessage *msg)
{
