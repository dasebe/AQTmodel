 ...
 */
class CF3 : public AdvancedAdversary
{
  protected:
...
void CF3::injectInitialPackets()
{
    ...
    AdvSchedMess * tmp;
    phaseCounter=200;  //currently overall time fixed to simTime<=100s
...
//round 1
        ...
        if(existsSimTimeLimit && (intervalStart+4* roundTime*(timeSlots->doubleValue()) > simTimeLimit))
        {
            return;
